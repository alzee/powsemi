...
//覆盖物
    var marker = new AMap.Marker({
        position: [110.613255,32.674916]
    });
    marker.setMap(map);
    var circle = new AMap.Circle({
        center: [110.613255,32.674916],
        radius: 100,
        fillOpacity: 0.2,
        strokeWeight: 1
    })
...
//自定义窗体
    var infowindow;
    var infoWindowContent = '<div class="infowindow-content"><h3>湖北力芯半导体有限公司</h3><p>地址：湖北省十堰市房县北城工业园一栋</p><p>服务热线：0719-3105699</p><p>联系电话：177-1237-7568</p></div>';
    map.plugin('AMap.AdvancedInfoWindow', function () {
        ...
        infowindow.open(map, [110.613255,32.674916]);
    });
